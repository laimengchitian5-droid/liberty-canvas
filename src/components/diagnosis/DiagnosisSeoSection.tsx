    ...
    <section className={styles.seo} aria-labelledby="diagnosis-about">
      ...
      <div className={styles.inner}>
        ...
        <p className={styles.lead}>
          心の色診断は、LibertyCanvas が提供する無料の性格診断です。{DIAGNOSTIC_QUESTION_COUNT}問のやさしい質問に答えるだけで、
          「共感」「論理」「感性」「導き」の4つの軸から、あなたに近いタイプを見つけられます。
          診断結果はそのまま AI に構造化データとして渡され、あなただけのパーソナルアドバイスが生成されます。
            ...
            return (
              <li key={category}>
                <article className={styles.typeCard}>
                  ...
                  <Link className={styles.typeLink} href={`/diagnosis/result/${category}`}>
                    {result.title}の詳細を見る
                  </Link>
                </article>
              </li>
        ...
        <ol className={styles.steps}>
          <li>「診断をはじめる」から{DIAGNOSTIC_QUESTION_COUNT}問の多肢選択に回答（所要約60秒）</li>
