...
const LEGAL_DISCLAIMER: Record<LandingLocale, string> = {
  en: "LibertyCanvas uses academic Big Five trait science and original Liberty archetypes — not licensed proprietary type instruments.",
...
export const LEGAL_SAFE_LANDING_OVERRIDES: LegalOverrideMatrix = {
  "enneagram-nine-types": {
    en: {
      ...
      title: "Free Motivation Spectrum Test — AI Cosmic Match | LibertyCanvas",
      headline: "Which of the 9 motivation patterns lives in you?",
      subhead:
        "One honest answer maps to LibertyCanvas motivation archetypes and affirming AI chat. Academic trait science — no signup.",
      metaDescription:
      ...
      schemaDescription:
        "Single-response motivation pattern discovery with affirming AI companion on LibertyCanvas.",
      faq: [
        {
          question: "Does this cover nine motivation patterns?",
          answer:
            "Yes — your answer maps to the closest LibertyCanvas motivation archetype in our academic matrix.",
        },
        {
    ...
    ja: {
      ...
      title: "無料動機スペクトル診断 — AI宇宙キャラ判定 | LibertyCanvas",
      headline: "9つの動機パターン、あなたの核はどれ？",
      subhead:
        "1つの本音回答で、LibertyCanvas の動機アーキタイプと全肯定AIチャットへ。学術5因子ベース・登録不要。",
      metaDescription:
      ...
      schemaDescription:
        "1回答型の動機パターン診断と全肯定AIコンパニオン（LibertyCanvas）。",
      faq: [
        {
          question: "9パターンすべて対応？",
          answer:
            "はい。回答は最も近い LibertyCanvas 動機アーキタイプにマッピングされます。",
        },
        {
    ...
    ko: {
      ...
      title: "무료 동기 스펙트럼 검사 — AI 우주 캐릭터 | LibertyCanvas",
      headline: "9가지 동기 패턴 중 당신의 핵심은?",
      subhead:
        "한 번의 솔직한 답변으로 LibertyCanvas 동기 아키타입과 전격 긍정 AI 채팅. 학술 Big Five 기반.",
      metaDescription:
      ...
      schemaDescription:
        "단일 응답 동기 패턴 발견 및 LibertyCanvas AI 동반 채팅.",
      faq: [
        {
          question: "9가지 패턴을 모두 지원하나요?",
          answer:
            "네. 답변은 가장 가까운 LibertyCanvas 동기 아키타입에 매핑됩니다.",
        },
        {
    ...
    zh: {
      keyword: "动机光谱 性格测试",
      title: "免费动机光谱测试 — AI 宇宙角色 | LibertyCanvas",
      headline: "九种动机模式，哪一种活在你心里？",
      subhead:
        "一次真实回答，映射 LibertyCanvas 动机原型与全肯定 AI 聊天。学术大五因子基础。",
      metaDescription:
      ...
      schemaName: "动机光谱性格测验",
      schemaDescription:
        "单次回答动机模式发现与 LibertyCanvas AI 陪伴聊天。",
      faq: [
        {
          question: "涵盖全部九种模式吗？",
          answer: "是的，回答会映射到最接近的 LibertyCanvas 动机原型。",
        },
        {
          question: "这是授权商用测验吗？",
  ...
  "sixteen-personalities": {
    en: {
      ...
      title: "Free Personality Spectrum Test — LibertyCanvas",
      headline: "Four trait axes. One honest answer. One cosmic character.",
      subhead:
        "Openness, empathy, drive, and stability — mapped to LibertyCanvas archetypes and affirming AI chat.",
      metaDescription:
      ...
      schemaDescription:
        "Single-answer four-axis personality spectrum with affirming AI chat on LibertyCanvas.",
      faq: [
        {
          question: "How is this scored?",
          answer:
            "We use academic Big Five trait vectors and LibertyCanvas original cosmic archetypes — not proprietary four-letter type codes.",
        },
        {
    ...
    ja: {
      ...
      title: "無料性格スペクトル診断 — 宇宙キャラ判定 | LibertyCanvas",
      headline: "4つの性格軸。1つの本音。1つの宇宙キャラ。",
      subhead:
        "開放性・共感・推進力・安定性を LibertyCanvas の宇宙アーキタイプと全肯定AIチャットへ。",
      metaDescription:
      ...
      schemaDescription: "1回答型4軸性格スペクトル診断（LibertyCanvas）。",
      faq: [
        {
          question: "採点方式は？",
          answer:
            "学術的ビッグファイブ因子と LibertyCanvas オリジナルの宇宙アーキタイプで判定します。4文字タイプコードは使いません。",
        },
        {
          question: "結果はどれくらい早い？",
    ...
    ko: {
      ...
      title: "무료 성격 스펙트럼 검사 — LibertyCanvas",
      headline: "4가지 성격 축. 한 답변. 하나의 우주 캐릭터.",
      subhead:
        "개방성·공감·추진력·안정성을 LibertyCanvas 우주 아키타입과 AI 채팅으로 매핑.",
      metaDescription:
      ...
      schemaDescription: "단일 응답 4축 성격 스펙트럼 (LibertyCanvas).",
      faq: [
        {
          question: "채점 방식은?",
          answer:
            "학술 Big Five 요인과 LibertyCanvas 우주 아키타입을 사용합니다. 4글자 유형 코드는 사용하지 않습니다.",
        },
    ...
    zh: {
      keyword: "四轴性格光谱测试",
      title: "免费性格光谱测试 — LibertyCanvas",
      headline: "四条性格轴。一次回答。一个宇宙角色。",
      subhead:
        "开放性·共情·驱动力·稳定性映射到 LibertyCanvas 宇宙原型与全肯定 AI 聊天。",
      metaDescription:
      ...
      schemaName: "性格光谱测验",
      schemaDescription: "单次回答四轴性格光谱（LibertyCanvas）。",
      faq: [
        {
          question: "如何计分？",
          answer:
            "使用学术大五因子与 LibertyCanvas 原创宇宙原型，不使用四字母类型代码。",
        },
  ...
  "mbti-personality-types": {
    en: {
      ...
      title: "Free Personality Type Spectrum — AI Finder | LibertyCanvas",
      ...
      schemaDescription:
        "Single-response academic trait spectrum discovery on LibertyCanvas.",
      faq: [
        {
    ...
    ja: {
      ...
      title: "無料性格タイプスペクトル診断 — AI宇宙キャラ | LibertyCanvas",
      headline: "学術5因子から、1回答で宇宙キャラへ",
      subhead:
        "外向性・開放性・共感・誠実性・感情安定性を LibertyCanvas 宇宙アーキタイプにマッピング。",
      metaDescription:
      ...
      schemaDescription: "1回答型学術因子スペクトル診断（LibertyCanvas）。",
      faq: [
        {
    ...
    ko: {
      ...
      title: "무료 성격 유형 스펙트럼 — AI 우주 캐릭터 | LibertyCanvas",
      headline: "학술 5요인에서 한 답변, 우주 캐릭터까지",
      subhead:
        "외향성·개방성·공감·성실성·정서 안정성을 LibertyCanvas 우주 아키타입으로 매핑.",
      metaDescription:
      ...
      schemaDescription: "단일 응답 학술 요인 스펙트럼 (LibertyCanvas).",
      faq: [
        {
    ...
    zh: {
      keyword: "性格类型光谱测试",
      title: "免费性格类型光谱 — AI 宇宙角色 | LibertyCanvas",
      headline: "学术五因子，一次回答，一个宇宙角色",
      subhead:
        "外向性·开放性·共情·尽责性·情绪稳定映射到 LibertyCanvas 宇宙原型。",
      metaDescription:
      ...
      schemaName: "性格类型光谱测验",
      schemaDescription: "单次回答学术因子光谱（LibertyCanvas）。",
      faq: [
        {
          question: "官方授权测验吗？",
          answer: LEGAL_DISCLAIMER.zh,
