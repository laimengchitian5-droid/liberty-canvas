...
export const LANDING_COPY: CopyMatrix = {
  ...
  "big-five-ocean": {
    en: {
      ...
      subhead:
        "Openness, Conscientiousness, Extraversion, Agreeableness, Neuroticism — mapped instantly by Liberty Discover AI. No signup.",
      metaDescription:
      ...
      schemaDescription:
        "Single-response Big Five (OCEAN) personality assessment with instant AI feedback on Liberty Discover.",
      faq: [
        {
          question: "Is this the official Big Five test?",
          answer:
            "This is a fast Liberty Discover intake mapped to OCEAN dimensions, designed for instant self-insight rather than clinical certification.",
        },
        {
          question: "Do I need an account?",
          answer: "No. One text answer routes directly into the global Liberty engine.",
        },
      ],
    },
    ja: {
      ...
      subhead:
        "開放性・誠実性・外向性・協調性・神経症傾向を Liberty Discover AI が即座にマッピング。登録不要。",
      metaDescription:
      ...
      schemaDescription:
        "1回答型ビッグファイブ（OCEAN）性格診断。Liberty Discover で即座にAIフィードバック。",
      faq: [
        {
          question: "本格的なビッグファイブ検査ですか？",
          answer:
            "Liberty Discover の高速インテークで OCEAN 次元にマッピングする自己理解ツールです。",
        },
        {
          question: "アカウントは必要？",
    ...
    ko: {
      ...
      subhead:
        "개방성·성실성·외향성·친화성·신경증 — Liberty Discover AI가 즉시 분석. 가입 불필요.",
      metaDescription:
      ...
      schemaDescription:
        "단일 응답 빅파이브(OCEAN) 성격 평가. Liberty Discover에서 즉시 AI 피드백.",
      faq: [
        {
          question: "공식 빅파이브 검사인가요?",
          answer:
            "Liberty Discover 고속 인테이크로 OCEAN 차원에 매핑하는 자기 이해 도구입니다.",
        },
        {
          question: "계정이 필요한가요?",
    ...
    zh: {
      ...
      subhead:
        "开放性·尽责性·外向性·宜人性·神经质 — Liberty Discover AI 即时映射。无需注册。",
      metaDescription:
      ...
      schemaDescription: "单次回答大五人格（OCEAN）评估。Liberty Discover 即时 AI 反馈。",
      faq: [
        {
          question: "这是正式的大五人格测验吗？",
          answer: "这是 Liberty Discover 快速摄入，映射到 OCEAN 维度的自我理解工具。",
        },
        {
          question: "需要账号吗？",
  ...
  "enneagram-nine-types": {
    en: {
      ...
      subhead:
        "One raw answer. Instant archetype match and affirming AI chat on Liberty Discover.",
      metaDescription:
      ...
      faq: [
        {
          ...
          answer:
            "Yes — your answer maps to the closest Enneagram archetype in our matrix.",
        },
        {
          question: "Is it free?",
    ...
    ko: {
      ...
      faq: [
        ...
        {
          question: "무료인가요?",
          answer: "liberty-canvas.vercel.app에서 완전 무료입니다.",
        },
      ],
    },
    zh: {
  ...
  "sixteen-personalities": {
    en: {
      ...
      metaDescription:
        "Free 16Personalities-style MBTI test. One response, freakishly accurate AI archetype and chat. No login on Liberty Discover.",
      keywords: [
        "16personalities",
      ...
      faq: [
        {
          ...
          answer:
            "Inspired by the same 16-type framework; powered by Liberty Discover open AI.",
        },
        {
    ...
    ja: {
      ...
      metaDescription:
        "16Personalities風 無料MBTI性格診断。1回答でAIタイプ判定＆チャット。Liberty Discover ログイン不要。",
      keywords: [
        "16personalities 日本語",
        "16性格 診断 無料",
        "MBTI テスト 無料",
      ...
      faq: [
        {
          ...
          answer: "同じ16タイプ框架を参考に、Liberty Discover オープンAIで駆動。",
        },
        {
          question: "結果はどれくらい早い？",
          answer: "即座 — テキストがグローバルエンジンへ。",
        },
      ],
    },
    ko: {
      ...
      metaDescription:
        "16Personalities 스타일 무료 MBTI 검사. 한 응답으로 AI 유형 및 채팅. Liberty Discover 로그인 불필요.",
      keywords: [
        "16personalities 한국어",
        "16유형 성격검사",
        "MBTI 무료",
      ...
      faq: [
        {
          ...
          answer: "동일 16유형 프레임워크 영감, Liberty Discover 오픈 AI 구동.",
        },
    ...
    zh: {
      ...
      metaDescription:
        "16Personalities 风格免费 MBTI 测试。一次回答，AI 类型与聊天。Liberty Discover 无需登录。",
      keywords: [
        "16personalities 中文",
        "16型人格测试",
        "MBTI 免费",
      ...
      faq: [
        {
          ...
          answer: "参考相同 16 型框架，由 Liberty Discover 开源 AI 驱动。",
        },
  ...
  "mbti-personality-types": {
    ...
    zh: {
      ...
      metaDescription: "免费 MBTI 性格类型测试。一次回答，AI 类型查找与聊天。16 型框架。",
      keywords: [
        "MBTI 测试 免费",
        "MBTI 性格类型",
        "迈尔斯布里格斯",
  ...
  "introvert-personality": {
    ...
    ja: {
      ...
      metaDescription: "無料内向型性格診断。1回答で内向レベル判定とAIチャット。",
      keywords: [
        "内向型 診断",
        "内向 外向 診断",
        "内向型 テスト 無料",
    ...
    ko: {
      ...
      metaDescription: "무료 내향형 성격 검사. 한 답변으로 내향 수준과 AI 채팅.",
      keywords: [
        "내향형 테스트",
        "내향 외향 검사",
        "내향인 테스트 무료",
    ...
    zh: {
      ...
      metaDescription: "免费内向型性格测试。一次回答揭示内向程度与 AI 聊天。",
      keywords: [
        "内向型测试",
        "内向 外向 测试",
        "内向人格 免费",
  ...
  "love-language-test": {
    ...
    ko: {
      ...
      metaDescription: "무료 사랑의 언어 성격 검사. 한 답변으로 연애 아키타입과 AI 채팅.",
      keywords: [
        "사랑의 언어 테스트",
        "5가지 사랑의 언어",
        "연애 성격검사",
    ...
    zh: {
      ...
      metaDescription: "免费爱的语言性格测试。一次回答，恋爱原型与 AI 聊天。",
      keywords: [
        "爱的语言测试",
        "五种爱的语言",
        "恋爱 性格测试",
  ...
  "attachment-style": {
    en: {
      ...
      subhead:
        "Relationship psychology made lightweight. Native text → global AI engine.",
      metaDescription:
    ...
    ko: {
      ...
      metaDescription: "무료 애착 유형 검사. 안정·불안·회피·혼란 — 한 답변 AI 인사이트.",
      keywords: [
        "애착 유형 테스트",
        "애착 이론 검사",
        "안정형 불안형 회피형",
    ...
    zh: {
      ...
      metaDescription: "免费依恋类型测试。安全型、焦虑型、回避型 — 一次回答 AI 洞察。",
      keywords: [
        "依恋类型测试",
        "依恋理论 测验",
        "安全型 焦虑型 回避型",
  ...
  "burnout-personality": {
    ...
    ko: {
      ...
      metaDescription: "무료 번아웃 성격 검사. 한 답변으로 번아웃 위험 유형과 AI 코칭.",
      keywords: [
        "번아웃 테스트",
        "번아웃 성격",
        "번아웃 검사 무료",
    ...
    zh: {
      ...
      metaDescription: "免费 burnout 性格测试。一次回答揭示 burnout 风险类型与 AI 教练。",
      keywords: [
        "burnout 测试",
        "职业倦怠 性格",
        "burnout 测验 免费",
  ...
  "inner-child-healing": {
    ...
    ko: {
      ...
      metaDescription: "무료 내면아이 성격 퀴즈. 한 답변으로 감정 패턴 AI 성찰 채팅.",
      keywords: [
        "내면아이 테스트",
        "내면아이 치유 퀴즈",
        "내면아이 워크 무료",
    ...
    zh: {
      ...
      metaDescription: "免费内在小孩性格测验。一次回答，AI 反思聊天探索情感模式。",
      keywords: [
        "内在小孩测试",
        "内在小孩疗愈 测验",
        "内在小孩 免费",
    ...
    en: {
      ...
      faq: [
        ...
        },
        {
          ...
          answer: LANDING_BRAND_NARRATIVE_EN,
        },
      ],
    },
    ja: {
      ...
      faq: [
        ...
        {
          question: "誰が作った？",
          answer: LANDING_BRAND_NARRATIVE_JA,
        },
      ],
    },
    ko: {
      ...
      faq: [
        ...
        { question: "제작?", answer: `${LANDING_PARENT_NAME} — Lu + Bel.` },
      ],
    },
    zh: {
      keyword: "阴影自我 原型测试",
      ...
      faq: [
        ...
        { question: "谁制作的？", answer: `${LANDING_PARENT_NAME} — Lu + Bel。` },
      ],
    },
  },
};
...
function hydrateLandingBrand(
  ...
  return {
    ...copy,
    title: toDiscoverBrand(copy.title),
    headline: toDiscoverBrand(copy.headline),
    subhead: toDiscoverBrand(copy.subhead),
    metaDescription: toDiscoverBrand(copy.metaDescription),
    schemaDescription: toDiscoverBrand(copy.schemaDescription),
    keywords,
    faq: copy.faq.map((item) => ({
      question: toDiscoverBrand(item.question),
      answer: toDiscoverBrand(item.answer),
    })),
  };
}
