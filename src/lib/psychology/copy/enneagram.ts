...
export const ENNEAGRAM_COPY: Record<LandingLocale, EnneagramLocaleCopy> = {
  en: {
    ...
    headline: "Empathetic Motivation Spectrum Diagnosis",
    subhead:
      "Pick the drive pattern that resonates. Instant cosmic character reveal. All-affirming AI chat on LibertyCanvas.",
    promptLabel: "Which motivation pattern feels most like you right now?",
    submitLabel: "Reveal My Drive Pattern",
    trustLine: "No login · Free · All-Affirming AI Chat",
    revealTitle: "Your motivation mirror is ready",
    chatPlaceholder: "Ask the AI about your drive pattern…",
    shareLabel: "Share on X / LINE",
    retakeLabel: "Retake",
    typingLabel: "AI is reflecting…",
    faq: [
      {
        question: "Is the Motivation Spectrum test free on LibertyCanvas?",
        answer:
          "Yes — no login, no paywall. Academic trait mapping with an affirming AI mirror for your inner drive.",
      },
      {
        question: "Can I chat with AI about my pattern?",
        answer:
          "Absolutely. All-affirming chat quotes your exact selection for empathetic validation.",
      },
    ],
    types: typesEn(),
  },
  ja: {
    ...
    headline: "共感型動機スペクトル診断",
    subhead:
      "今の自分に近い動機パターンを直感選択。即宇宙キャラ表示。全肯定 AI チャット付き。",
    promptLabel: "今の自分に一番近い動機パターンは？",
    submitLabel: "動機パターンを表示",
    trustLine: "ログイン不要 · 無料 · 全肯定 AI チャット",
    revealTitle: "あなたの動機ミラー完成",
    chatPlaceholder: "このパターンについて AI に聞いてみよう",
  ...
  ko: {
    ...
    headline: "공감형 동기 스펙트럼 진단",
    subhead:
      "지금의 나와 가장 가까운 동기 패턴을 선택하세요. 즉시 우주 캐릭터 공개. 전격 긍정 AI 채팅.",
    promptLabel: "지금의 나와 가장 가까운 동기 패턴은?",
    submitLabel: "동기 패턴 보기",
    trustLine: "로그인 불필요 · 무료 · 전격 긍정 AI",
    revealTitle: "동기 미러 완성",
    chatPlaceholder: "이 패턴에 대해 AI에게 물어보세요",
    shareLabel: "X / LINE 공유",
    retakeLabel: "다시 하기",
    typingLabel: "AI가 공감 중…",
    faq: [
      {
        question: "동기 스펙트럼 진단은 무료인가요?",
        answer: "네. LibertyCanvas는 로그인 없이 이용 가능합니다.",
      },
      {
        question: "AI와 패턴에 대해 대화할 수 있나요?",
        answer: "네. 전격 긍정 AI가 선택을 인용해 공감합니다.",
      },
    ],
    types: typesKo(),
  },
  zh: {
    ...
    revealTitle: "你的动机镜像已完成",
    chatPlaceholder: "向 AI 询问你的动机模式…",
    ...
    faq: [
      {
        question: "动机光谱诊断免费吗？",
        answer: "是的，LibertyCanvas 无需登录即可使用。",
      },
      {
        question: "可以和 AI 聊动机模式吗？",
        answer: "可以，全肯定 AI 会引用你的选择进行共情。",
      },
    ],
    types: typesZh(),
  },
